...
<!--<MarkdownReplacement with="Using-the-Tools.md">--><h1>Using the Tools</h1>

<p>So you completed the [[Ants Five Minute Quickstart Guide]] , and you see your name on the leaderboard. Now what? In this guide, you will use the Ants game visualizer to watch two of the sample bots play against each other.</p>

<p>If you have any trouble with this tutorial, please complain on the <a href="http://ai-contest.com/forum/">forums</a> so that we know to fix it. We'll do whatever it takes to get you off the ground!</p>

<h2>Getting the Tools</h2>

<p>Download the tools for <a href="http://ai-contest.com/tools.zip">Windows</a> or <a href="http://ai-contest.com/tools.tar.bz2">Linux/MacOS</a>. And if you haven't done so already, download a <a href="http://ai-contest.com/starter_packages.php">starter package</a>.
Unzip the packages in a location of your choice. Since we will be using a command-line terminal in this tutorial, it is better to choose a location that is easy to find using a terminal.</p>

<h2>Watch Bots Fight</h2>
...
<h2>Submit Your Code Online</h2>

<p>When you submit your code on the Google AI Challenge website, it automatically starts playing against bots submitted by other people from around the world. Within a few minutes, your name will show up in the global rankings. You can submit your bot many times before the deadline.</p>
...
<p>To submit your code online, make sure that your account is activated and you are signed in to the website, then visit the <a href="http://ai-contest.com/submit.php">Upload Your Code</a> page.</p>
